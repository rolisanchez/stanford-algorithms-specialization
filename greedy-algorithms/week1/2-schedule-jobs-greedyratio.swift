...
do {
    if let contents = try? String(contentsOfFile: filepath) {
        ...
        var minHeap = Heap<[String:Double]>([], areSorted: { (el1, el2) in
            ...
            let el1Ratio: Double = el1Weight / el1Length

            let el2Weight = el2["weight"]!
            let el2Length = el2["length"]!
            let el2Ratio: Double = el2Weight / el2Length

            if el1Ratio == el2Ratio {
                return el1Weight > el2Weight
            } else {
                return el1Ratio > el2Ratio
            }
        })
        ...
        for line in lines {
            ...
            let jobWeight = Double(lineContents[0])!
            let jobLength = Double(lineContents[1])!

            var job = [String:Double]()
        ...
        var sumWeightedCompletionTimes: Double = 0
