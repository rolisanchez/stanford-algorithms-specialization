...
func topoSort(graph: Graph) -> [Int] {
    print("Executing topoSort")
    // var currentLabel = graph.vertices.count
    // var currentLabel = 11
    var currentLabel = 875714
...
//    }
    ...
    for (index, SCC) in sortedSCCs[0..<6].enumerated() {
        print("SCC number \(index) components = \(SCC.components)")
    }

}

// let filepath = "./SCCSmall.txt"
let filepath = "./SCC.txt"
